...
module.exports = ({ config, output, injectConfig = true, skipConcat = false, template='code' }, callback) => {
  ...
  compiler.run(function(err, stats) {
    ...
    if (webpackConfig.entry.vendor) fs.unlinkSync(path.resolve(output, 'vendor.js'));
